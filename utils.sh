...
function printHelp() {
  ...
  if [ "$USAGE" == "up" ]; then
  ...
  elif [ "$USAGE" == "createChannel12" ]; then
    println "Usage: "
    println "  network.sh \033[0;32mcreateChannel12\033[0m [Flags]"
    println
    println "    Flags:"
    println "    -c <channel name> - Name of channel to create (defaults to \"chanorg1org2\")"
    println "    -r <max retry> - CLI times out after certain number of attempts (defaults to 5)"
    println "    -d <delay> - CLI delays for a certain number of seconds (defaults to 3)"
    println "    -verbose - Verbose mode"
    println
    ...
    println
    println " Possible Mode and flag combinations"
    println "   \033[0;32mcreateChannel12\033[0m -c -r -d -verbose"
    println
    println " Examples:"
    println "   network.sh createChannel12 -c channelName"
  elif [ "$USAGE" == "createChannel23" ]; then
    println "Usage: "
    println "  network.sh \033[0;32mcreateChannel23\033[0m [Flags]"
    println
    println "    Flags:"
    println "    -c <channel name> - Name of channel to create (defaults to \"chanorg2org3\")"
    println "    -r <max retry> - CLI times out after certain number of attempts (defaults to 5)"
    println "    -d <delay> - CLI delays for a certain number of seconds (defaults to 3)"
    println "    -verbose - Verbose mode"
    println
    ...
    println
    println " Possible Mode and flag combinations"
    println "   \033[0;32mcreateChannel23\033[0m -c -r -d -verbose"
    println
    println " Examples:"
    println "   network.sh createChannel23 -c channelName"
    ...
    elif [ "$USAGE" == "deployCC23" ]; then
    println "Usage: "
    println "  network.sh \033[0;32mdeployCC23\033[0m [Flags]"
    println
    println "    Flags:"
    println "    -c <channel name> - Name of channel to deploy chaincode to"
    println "    -ccn <name> - Chaincode name."
    ...
    println
    println " Possible Mode and flag combinations"
    println "   \033[0;32mdeployCC23\033[0m -ccn -ccl -ccv -ccs -ccp -cci -r -d -verbose"
    println
    println " Examples:"
    println "   network.sh deployCC23 -ccn basic -ccp ../asset-transfer-basic/chaincode-javascript/ ./ -ccl javascript"
    println "   network.sh deployCC23 -ccn mychaincode -ccp ./user/mychaincode -ccv 1 -ccl javascript"
  else
    println "Usage: "
